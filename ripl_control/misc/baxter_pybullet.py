...
# from pybullet_interface.limb import *
# from pybullet_interface.gripper import *


class BaxterPyBullet(object):
    def __init__(self, baxter_path="/home/ripl/ripl-control/ripl_control/assets/baxter_robot/baxter_description/urdf/baxter.urdf",
                 control=None,
                 limbs=None,
                 use_ik=True,
                 use_simulation=True,
        ...
        self._joints_arms = {
            'left': {0: 34, 1: 35, 2: 36,
                     3: 37, 4: 38, 5: 40, 6: 41},
            'right': {0:12, 1: 13, 2: 14,
                      3: 15, 4: 16, 5: 18, 6: 19}}

        self._joints_all = {
                0: 34, 1: 35, 2: 36, 3: 37, 4: 38, 5: 40, 6: 41,
                7: 12, 8: 13, 9: 14, 10: 15, 11: 16, 12: 18, 13: 19}

        self.reset()

    def reset(self):
        # Load baxter
        objects = [p.loadURDF(self.baxter_path, [0.00000,0.000000, 0.00000,], useFixedBase=True)]
    ...
    def set_initial_pose(self):
        ...
        for joint_index, joint_val in self.initial_pose:
            ...
            # p.setJointMotorControl2(self.baxter_id, joint_index, p.POSITION_CONTROL, joint_val, force=self.max_force)
