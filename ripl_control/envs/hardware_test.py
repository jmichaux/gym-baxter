...
"""
Test real robot stuff
"""
# initialize a node
rospy.init_node('env_test')
baxter = Baxter(arms="right")
...
#
# action = real_joints.values()
# if baxter._arms == "both":
#     action = [0]*7 + action
# start = time.time()
# baxter.apply_action(action)
# baxter.right_arm.set_joint_positions(real_joints)
